...
import com.example.kloset_lab.global.security.config.RestClientConfig;
...
public class HttpAIClient implements AIClient {
    ...
    public BatchResponse analyzeImages(Long userId, List<String> imageUrlList) {
        ...
        List<FileUploadResponse> fileUploadResponses = mediaService.requestFileUpload(userId, Purpose.CLOTHES, fileUploadInfos);
    ...
    public OutfitResponse recommendOutfit(Long userId, String query) {
        ...
        List<FileUploadResponse> fileUploadResponses = mediaService.requestFileUpload(userId, Purpose.OUTFIT, fileUploadInfos);
